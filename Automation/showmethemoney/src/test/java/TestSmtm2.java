...
public class TestSmtm2 extends BaseTest {
        ...
        public void testBuyFromMyInvestments() {
                try {
                        ...
                        test.log(Status.INFO,
                                        "Clicked on " + data.getTest1data().getAsset() + " investment item");
                        ...
                        test.log(Status.INFO, "Verified " + data.getTest1data().getAsset()
        ...
        public void testSellFromMyInvestments() {
                try {
                        ...
                        test.log(Status.INFO,
                                        "Starting test case: Second test - Sell from my investment section");
                        misInversionesPage.clickMyInvestmentItem(data.getTest2data().getAsset());
                        test.log(Status.INFO,
                                        "Clicked on " + data.getTest2data().getAsset() + " investment item");
                        ...
                        test.log(Status.INFO, "Verified " + data.getTest2data().getAsset()
        ...
        public void testBuyFromOtherInvestments() {
                try {
                        ...
                        test.log(Status.INFO,
                                        "Clicked on " + data.getTest3data().getAsset() + " investment item");
                        ...
                        test.log(Status.INFO, "Verified " + data.getTest3data().getAsset()
